 ...
 *      generated against. The library deliberately does not include
 *      its own Poseidon implementation; any Solidity-side keccak
 *      placeholder would produce hashes incompatible with the circuit.
 */
library MerkleTree {
